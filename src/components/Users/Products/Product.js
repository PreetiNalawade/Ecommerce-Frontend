...
export default function Product() {
  ...
  const productExists = cartItems?.some(
    (item) => item?._id?.toString() === products?.product?._id?.toString()
  );
  ...
  const addToCartHandler = () => {
    ...
    if (productExists) {
      return Swal.fire({
        icon: "error",
        title: "Oops...!",
        text: "This product is already added to the cart!",
      });
    }
    ...
    dispatch(
      addOrderToCartAction({
        ...
        qtyLeft: products?.product?.qtyLeft,
      })
    );
    Swal.fire({
      icon: "success",
      ...
      <main className="mx-auto mt-8 max-w-2xl px-4 pb-16 sm:px-6 sm:pb-24 lg:max-w-7xl lg:px-8">
        <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center">
                <p className="text-sm text-gray-700">
                  {productDetails?.products?.product?.averageRating}
                ...
                <div className="ml-4 flex">
                  ...
                  >
                    {productDetails?.products?.totalReviews} total reviews
                  </a>
                </div>
              </div>
              {/* leave a review */}
              ...
              <div className="mt-4">
                <Link to={`/add-review/${products?._id}`}>
          ...
          <div className="mt-8 lg:col-span-7 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:mt-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 lg:gap-8">
              {products?.product?.images.map((image) => (
                <img
                  key={image.id}
                  src={image}
                  alt={image}
            ...
            <>
              ...
              {products?.qtyLeft <= 0 ? (
                <button
                  ...
                  disabled
                  className="mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-gray-600 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Add to cart
                </button>
              ) : (
        ...
        <section aria-labelledby="reviews-heading" className="mt-16 sm:mt-24">
          ...
          <div className="mt-6 space-y-10 divide-y divide-gray-200 border-t border-b border-gray-200 pb-10">
            {productDetails?.products?.product?.reviews.map((review) => (
              <div
                key={review._id}
