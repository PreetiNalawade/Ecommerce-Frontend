...
import { createColorAction } from "../../../redux/slices/categories/colorSlices";
...
export default function AddColor() {
  ...
  //get data from store
  const { color, loading, error, isAdded } = useSelector(
    (state) => state?.colors
  );
  return (
    <>
      {isAdded && <SuccessMsg message="Color created " />}
